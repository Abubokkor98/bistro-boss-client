 ...
 * 3. create stripe sccount and get publishable key
 ...
 * install stripe on the server side and get client secret and save it. make sure you used the payment method types: ['card]
